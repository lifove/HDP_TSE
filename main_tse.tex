...
\author{Jaechang~Nam,~%~\IEEEmembership{Member,~IEEE,}
        ...
        and~Lin Tan% <-this % stops a space
...
projects with heterogeneous metric sets. Second, it is not well-studied when we can conduct effective CPDP. In other words, since a target dataset have few data samples as its history is short, it is important to investigate the lower bounds of data samples for effective CPDP.
