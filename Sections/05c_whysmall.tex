...
i.e., they are divided into $b=2$ bins \lin{I don't quite understand this. Expand the explanation?}.
...
the number if bins per dimension is three or less then 50 samples will suffice; else, up to 100
