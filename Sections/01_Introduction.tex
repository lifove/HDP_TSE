...
\bi
\item
{\em Software metrics} are the terms used to  describing software projects. Commonly
...
in historical data by reusing information from other other project. As shown in Figure~\ref{fig:subfig2}, in CPDP,
...
standard CPDP requires that all projects collect exactly the same metrics (as shown Figure~\ref{fig:subfig2}). Finding other projects with exactly
