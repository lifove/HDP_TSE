...
If HDP requires many source or target instances to compare there distributions, HDP may not be effective to build a prediction model for the small datasets. We address this limit experimentally as well as theoretically in this paper.
