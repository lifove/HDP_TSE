...
\squishlist
  \item Propose the heterogeneous defect prediction models.
  \item Conduct an extensive and large-scale empirical study to evaluate
  the heterogeneous defect prediction models.
  \item Validate the lower bounds of the size of source and target datasets for effective transfer learning in defect prediction.
\squishend
