...
Our experimental results on RQ1 (in Section~6) show that HDP models are feasible and their prediction
...
That analysis concludes that the Section~7 are actually representative of the general case; i.e. transfer should be possible after a mere few hundred examples. 
