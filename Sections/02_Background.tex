...
Pan\&Yang~\cite{Pan10} is the definitive definition of
transfer learning.

Pan\&Yang state that transfer learning is defined over a {\em domain} $D$,
...
According to Pan\&Yang, synonyms for transfer learning include, learning
...
Pan\&Yang~\cite{pan10} define four types of transfer learning:
\bi
\item
...
which classes have the most defects so that she can focus system
testing:
...
genetic algorithms to automatically learn weights for different parameters~\cite{sigweni2014feature}. Such work is ane example of {\em parameter transfer}.
