...
\squishlist
  ...
  (Baseline1)?
  \item RQ2: Is  heterogeneous defect prediction comparable to
  CPDP using common metrics (CPDP-CM, Baseline2)?
   \item RQ3: Is  heterogeneous defect prediction comparable to
  CPDP-IFS (Baseline3)?
   \item RQ4: What are the  lower  bounds  of  the  size  of source and target  datasets  for  effective HDP.
