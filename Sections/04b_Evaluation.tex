...
\item
  The {\em colourful} lines show results from transferring from {\em some} small $N$ number of samples
  in the source data.
\item
...
Working in the domain cardiology,
  ...
  randomly selected defective modules, then randomly added $(N-M)$ non-defective modules for $N\in \{50,100,150,250\}$.
...
\item
  The {\em black/colourful} lines show the results using {\em all/some} of the data, respectively
